...
const EditProfile = (props) => {
    ...
    if (userID) {
      getDocumentById('users', userID, (data) => {
        if (data) {
          ...
          setPhoneEntered(data.contact_no)
          setDobEntered(data.date_of_birth)
          setAboutEntered(data.about_us)
          setemailEntered(data.email)
          setaddressEntered(data.address)
          setcityEntered(data.city)
          setstateEntered(data.state)
          setzipEntered(data.zipcode)
          setcountryEntered(data.country)
          setprofileheadEntered(data.profilehead)
          setrelationEntered(data.marital_status)
          setchildrenEntered(data.other_details.children)
          setprofessionEntered(data.generes)
          seteducateEntered(data.other_details.education)
          setlanguageEntered(data.other_details.language)
          setheightEntered(data.other_details.height)
          setweightEntered(data.other_details.weight)
          setbodyEntered(data.other_details.body)
          setstatusEntered(data.other_details.status)
          sethairEntered(data.other_details.hair)
          seteyeEntered(data.other_details.eye)
  ...
  const statechangeHandler = (event) => {
    setstateEntered(event.target.value)
  }
  ...
  const submitHandler = (event) => {
    ...
    createProfileCheckSchema.validate({
      ...
      other_details: { childrenEntered, educateEntered, languageEntered, heightEntered, weightEntered, bodyEntered, statusEntered, hairEntered, eyeEntered }
