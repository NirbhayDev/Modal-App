...
const CreateProfile = () => {
  ...
  useEffect(() => {
    ...
    if (userInfo != null) {
      ...
      let usernameArray = userData.user_name.split(" ");
  ...
  const submitHandler = (event) => {
    ...
    createProfileCheckSchema.validate({
      ...
      setErrorText('')
      let userName = fnameEntered + ' ' + lnameEntered;
      let profileObj = {
        user_name: userName,
        about_us: aboutEntered,
        contact_no: phoneEntered,
                ...
                <div className='main_container white-bg'>
                  ...
                  <form className='signup-form' onSubmit={submitHandler}>
                    ...
                    <div class='mb-3'>
                      ...
                      <textarea
                        className='form-control input-boxes textarea' onChange={aboutchangeHandler}
                        value={aboutEntered}
                      />
                    </div>
