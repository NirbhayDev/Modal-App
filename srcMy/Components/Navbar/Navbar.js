                    ...
                    <div className='list-group list-group-flush'>
                      ...
                      <Link className='list-group-item list-group-item-action border-bottom'>
                        <div className='row align-items-center'>
                          <div className='col-auto'> <img alt='Image placeholder' 
                ...
                <li className='nav-item dropdown ms-lg-3'>
                  <button className='btnNavAvtar' onClick={() => { setShowMenu(!isShowMenu) }}>
                    <div className='media d-flex align-items-center'>
                      <img className='avatar rounded-circle' alt='Image placeholder' src={profileImg?profileImg:user} />
                    </div>
                  </button>
                  {isShowMenu
                    ? <div className='dropdownMenu mt-2 py-1'>
                      ...
                      <div role='separator' className='dropdown-divider my-1' />
                      <button className='dropdown-item d-flex align-items-center' onClick={()=>{logout()}}>Logout</button>
                      </div>
                    : null}
                </li>
